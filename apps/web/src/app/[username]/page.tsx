      ...
      <div className="grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <div>
            ...
            <div className="flex items-end gap-4 -mt-12 px-4">
              ...
              <div className="pb-2">
                <p className="text-[11px] font-semibold uppercase tracking-wide text-[#7c3aed]">{c.headline}</p>
            ...
            <section className="rounded-2xl border border-[#e5e7eb] bg-white p-6">
              ...
              <ul className="space-y-5">
                {c.reviewsReceived.map((r) => (
                  <li key={r.id} className="border-b last:border-0 border-[#e5e7eb] pb-5 last:pb-0">
        ...
        <aside className="lg:sticky lg:top-24 self-start">
          <div className="rounded-2xl border border-[#e5e7eb] bg-white p-5 shadow-sm">
            ...
            <Link href={`/messages?to=${c.username}`} className="mt-2 w-full inline-flex justify-center px-4 py-3 rounded-xl border border-[#0b0b14] text-[#0b0b14] font-bold hover:bg-[#f7f7fb]">
              Negotiate a package
            </Link>
