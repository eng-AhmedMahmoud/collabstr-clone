...
export const metadata = { title: "Saved creators — Nakhla" };
...
export default async function SavedPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      {saved.length === 0 ? (
        <p className="mt-8 text-center text-muted text-sm">No saved creators yet. <Link href="/influencers" className="underline">Browse to save</Link>.</p>
      ) : (
