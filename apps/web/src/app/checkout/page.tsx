...
export const metadata = { title: "Checkout — Collabstr" };
...
export default async function CheckoutPage({
  ...
  if (!creatorParam) {
    return (
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 text-center">
        ...
        <p className="text-[#6b7280] mt-2">Choose a package from a creator&apos;s profile to start checkout.</p>
  ...
  if (!pkg) {
    return <div className="p-12 text-center text-[#6b7280]">This creator has no packages yet.</div>;
  }
