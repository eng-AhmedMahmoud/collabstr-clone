...
export const metadata = { title: "Forgot password — Nakhla" };

export default function ForgotPasswordPage() {
  return (
    <div className="mx-auto max-w-md px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl font-black">Forgot password</h1>
      <p className="text-muted mt-1.5">Enter your email and we&apos;ll send a reset link.</p>
      ...
      <p className="text-xs text-muted mt-4">Reset emails are stubbed in this build — check the API logs for the link.</p>
